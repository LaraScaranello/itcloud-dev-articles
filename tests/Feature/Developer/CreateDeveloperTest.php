...
it('should be able to create a developer', function () {
    $skills = Skill::factory()->count(2)->create();

    Livewire::test(Developers\Create::class)
        ...
        ->set('form.skills', $skills->pluck('id')->toArray())
        ->assertSet('form.skills', $skills->pluck('id')->toArray())
        ->call('save')
        ->assertHasNoErrors();
