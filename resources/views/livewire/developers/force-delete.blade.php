<div>
    @if($modal)
        ...
        >
            ...
            <div class="relative z-10 w-full max-w-md overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-2xl dark:border-white/10 dark:bg-zinc-950">
                <div class="border-b border-zinc-200 px-6 py-5 dark:border-white/10">
                    <div class="flex items-start justify-between gap-4">
                        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-300">
                ...
                <div class="px-6 py-6">
                    <p class="text-sm text-zinc-700 dark:text-zinc-300">
                        ...
                        <span class="font-semibold text-zinc-900 dark:text-white">{{ $developer?->name }}</span>?
                    </p>
