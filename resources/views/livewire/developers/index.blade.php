<div class="px-4 sm:px-6 lg:px-0">
    ...
    <div class="mb-6 rounded-2xl border border-gray-800 bg-zinc-950/60 p-4 sm:p-5">
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4">
            ...
            <div class="flex items-center gap-3 border border-gray-500 rounded-lg px-4 py-2.5">
                <input
                    type="checkbox"
                    id="search_trash"
                ...
                <label for="search_trash" class="text-sm cursor-pointer">
                    Mostrar arquivados
                </label>
            </div>
        </div>
                    ...
                    <div class="mt-auto pt-2 flex gap-2 sm:justify-end">
                        @unless($developer->trashed())
                            <button
                                ...
                                class="flex-1 cursor-pointer sm:flex-none border border-gray-600 rounded-lg px-4 py-2 text-sm hover:bg-zinc-700 transition flex items-center justify-center"
                            >
                            ...
                            <button
                                type="button" @click="$dispatch('developer::archive', { id: {{ $developer->id }} })"
                                class="flex-1 cursor-pointer sm:flex-none border border-red-800 bg-red-900/30 text-red-300 rounded-lg px-4 py-2 text-sm hover:bg-red-900/50 transition flex items-center justify-center"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
