        ...
        <div class="border-b border-zinc-200 py-4 last:border-b-0 dark:border-white/10">
            <div class="flex items-start justify-between gap-3">
                <div class="min-w-0 flex-1">
                    <div class="flex items-start justify-between gap-3">
                        <div class="min-w-0 flex-1">
                            <h2 class="text-base font-semibold leading-tight break-words text-zinc-900 dark:text-white">
                                {{ $developer->name }}
                            </h2>

                            <p class="mt-1 whitespace-nowrap text-sm text-zinc-500 dark:text-zinc-400">
                                {{ $developer->email }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 flex flex-wrap gap-2">
                        <span class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium
                            {{ $seniorityColors[strtolower($developer->seniority)] ?? 'border border-zinc-200 bg-zinc-100 text-zinc-700 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200' }}">
                    ...
                    @unless($developer->trashed())
                        @can('update', $developer)
                            <button
                                ...
                                class="inline-flex h-9 w-9 cursor-pointer items-center justify-center rounded-lg border border-zinc-200 bg-white text-zinc-600 transition hover:bg-zinc-100 hover:text-zinc-900
